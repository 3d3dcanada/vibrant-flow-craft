...
import { 
  LayoutDashboard, Coins, Sparkles, Recycle, Gift, Users, Settings, 
  LogOut, ChevronLeft, ChevronRight, Crown, Zap, Star, Package,
  TreePine, Scale, Trophy, CreditCard, Menu, X
} from 'lucide-react';
...
const makerNav: NavItem[] = [
  { label: 'My Models', icon: Scale, href: '/dashboard/my-models' },
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto py-4">
        ...
        {subscription?.tier === 'maker' || subscription?.tier === 'pro' ? (
